...
public class FieldConstants {
  ...
  public static class Hub {
    ...
    public static final Translation3d topCenterPoint =
        new Translation3d(
            AprilTags.getTagPose(26).getX() + width / 2.0, fieldWidthMeters / 2.0, height);
    public static final Translation3d innerCenterPoint =
        new Translation3d(
            AprilTags.getTagPose(26).getX() + width / 2.0, fieldWidthMeters / 2.0, innerHeight);

    public static final Translation2d nearLeftCorner =
        new Translation2d(
            topCenterPoint.getX() - width / 2.0, fieldWidthMeters / 2.0 + width / 2.0);
    ...
    public static final Translation3d oppTopCenterPoint =
        new Translation3d(
            AprilTags.getTagPose(4).getX() + width / 2.0, fieldWidthMeters / 2.0, height);
    public static final Translation2d oppNearLeftCorner =
        new Translation2d(
            oppTopCenterPoint.getX() - width / 2.0, fieldWidthMeters / 2.0 + width / 2.0);
    ...
    // Hub faces
    public static final Pose2d nearFace = AprilTags.getTagPose(26).toPose2d();
    public static final Pose2d farFace = AprilTags.getTagPose(20).toPose2d();
    public static final Pose2d rightFace = AprilTags.getTagPose(18).toPose2d();
    public static final Pose2d leftFace = AprilTags.getTagPose(21).toPose2d();
  }

  public static class LinesVertical {
    public static final double center = fieldLengthMeters / 2.0;
    public static final double starting = AprilTags.getTagPose(26).getX();
    public static final double allianceZone = starting;
    public static final double hubCenter = AprilTags.getTagPose(26).getX() + Hub.width / 2.0;
    ...
    public static final double oppHubCenter = AprilTags.getTagPose(4).getX() + Hub.width / 2.0;
    public static final double oppAllianceZone = AprilTags.getTagPose(10).getX();
  }
  ...
  public static class LeftBump {
    ...
    public static final Rectangle2d bumpZone =
        new Rectangle2d(
            new Translation2d(
                nearLeftCorner.getX() - TunerConstants.bumperRadius + Units.inchesToMeters(4),
                nearLeftCorner.getY()),
            new Translation2d(
                farRightCorner.getX() + TunerConstants.bumperRadius - Units.inchesToMeters(4),
                farRightCorner.getY()));

    public static final Rectangle2d oppBumpZone =
        new Rectangle2d(
            new Translation2d(
                oppNearLeftCorner.getX() + TunerConstants.bumperRadius - Units.inchesToMeters(4),
                oppNearLeftCorner.getY()),
            new Translation2d(
                oppFarRightCorner.getX() - TunerConstants.bumperRadius + Units.inchesToMeters(4),
  ...
  public static class LeftTrench {
    ...
    public static final Translation3d oppOpeningTopRight =
        new Translation3d(
            LinesVertical.oppHubCenter, fieldWidthMeters - openingWidth, openingHeight);

    public static final Rectangle2d trenchZone =
        new Rectangle2d(
    ...
    public static final Rectangle2d oppTrenchZone =
        new Rectangle2d(
  ...
  public static class Tower {
    ...
    public static final Translation2d centerPoint =
        new Translation2d(frontFaceX, AprilTags.getTagPose(31).getY());
    public static final Translation2d leftUpright =
        new Translation2d(
            frontFaceX,
            (AprilTags.getTagPose(31).getY()) + innerOpeningWidth / 2 + Units.inchesToMeters(0.75));
    ...
    public static final Translation2d oppCenterPoint =
        new Translation2d(fieldLengthMeters - frontFaceX, AprilTags.getTagPose(15).getY());
    public static final Translation2d oppLeftUpright =
        new Translation2d(
            fieldLengthMeters - frontFaceX,
            (AprilTags.getTagPose(15).getY()) + innerOpeningWidth / 2 + Units.inchesToMeters(0.75));
    public static final Translation2d oppRightUpright =
        new Translation2d(
            fieldLengthMeters - frontFaceX,
            (AprilTags.getTagPose(15).getY()) - innerOpeningWidth / 2 - Units.inchesToMeters(0.75));

    public static final Pose2d leftOuterTowerPose =
        new Pose2d(
                frontFaceX - Units.inchesToMeters(3.5 / 2),
                leftUpright.getY()
                    + Units.inchesToMeters(0.75)
                    + Units.inchesToMeters(6)
                    + Units.inchesToMeters(3), // +3 in tolerance
                new Rotation2d(Units.degreesToRadians(0)))
            .transformBy(ClimbConstants.climbTransform);
    public static final Pose2d leftInnerTowerPose =
        new Pose2d(
                frontFaceX - Units.inchesToMeters(3.5 / 2),
                leftUpright.getY() + Units.inchesToMeters(0.75),
                new Rotation2d(Units.degreesToRadians(0)))
            .transformBy(ClimbConstants.climbTransform);
    public static final Pose2d rightOuterTowerPose =
        new Pose2d(
                frontFaceX - Units.inchesToMeters(3.5 / 2),
                rightUpright.getY()
                    - Units.inchesToMeters(0.75)
            ...
            .transformBy(ClimbConstants.climbTransform);
    public static final Pose2d rightInnerTowerPose =
        new Pose2d(
                frontFaceX - Units.inchesToMeters(3.5 / 2),
  ...
  public static class Depot {
    ...
    public static final Translation3d leftCorner =
        new Translation3d(
            depth, (fieldWidthMeters / 2) + distanceFromCenterY + (width / 2), height);
