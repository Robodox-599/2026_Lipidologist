...
public class ShotData {
  ...
  static {
    hubShotMap.put(1.41, new Shot(0.00, 49, 1.14));
    hubShotMap.put(1.83, new Shot(0.005, 52, 1.15));
    hubShotMap.put(2.24, new Shot(0.01, 55, 1.21));
    hubShotMap.put(2.645, new Shot(0.015, 56, 1.22));
    hubShotMap.put(3.000, new Shot(0.018, 58, 1.31));
    hubShotMap.put(3.404, new Shot(0.02, 60, 1.35));
    hubShotMap.put(3.803, new Shot(0.022, 63, 1.37));
    hubShotMap.put(4.215, new Shot(0.024, 65, 1.42));
    hubShotMap.put(4.63, new Shot(0.026, 68, 1.49));
    hubShotMap.put(5.04, new Shot(0.028, 71, 1.53));
    hubShotMap.put(5.39, new Shot(0.03, 73, 1.58));
  }
