...
public class jaidensAutos {
  private AutoFactory autoFactory;
  private Superstructure superstructureCommands;
  private CommandSwerveDrivetrain drivetrain;

  private static double shoot_without_agitation_secs = 0.8;
  ...
  public AutoRoutine hubDoubleDouble(boolean isLeft) {
    ...
    AutoTrajectory trench_only_1 =
        isLeft
            ? routine.trajectory("trench_only_1")
            : routine.trajectory("trench_only_1").mirrorY();
    AutoTrajectory trench_only_2_hub =
        isLeft
            ? routine.trajectory("trench_only_2_hub")
            : routine.trajectory("trench_only_2_hub").mirrorY();
    AutoTrajectory trench_only_3 =
        isLeft
            ? routine.trajectory("trench_only_3")
    ...
    trench_only_1
        ...
        .onTrue(
            Commands.sequence(
                superstructureCommands.setWantedSuperStateCommand(WantedSuperState.SHOOT_HUB),
  ...
  public AutoRoutine midDoubleDouble(boolean isLeft) {
    ...
    AutoTrajectory trench_only_1 =
        isLeft
            ? routine.trajectory("trench_only_1")
            : routine.trajectory("trench_only_1").mirrorY();
    AutoTrajectory trench_only_2_mid =
        isLeft
            ? routine.trajectory("trench_only_2_mid")
  ...
  public AutoRoutine midAnimalStyle(boolean isLeft) {
    ...
    AutoTrajectory trench_and_bump_2_mid =
        isLeft
            ? routine.trajectory("trench_and_bump_2_mid")
            : routine.trajectory("trench_and_bump_2_mid").mirrorY();
    AutoTrajectory trench_and_bump_3 =
        isLeft
            ? routine.trajectory("trench_and_bump_3")
  ...
  public AutoRoutine safeDoubleDouble(boolean isLeft) {
    ...
    AutoTrajectory trench_only_1 =
        isLeft
            ? routine.trajectory("trench_only_1")
            : routine.trajectory("trench_only_1").mirrorY();
    AutoTrajectory trench_only_2_safe =
        isLeft
            ? routine.trajectory("trench_only_2_safe")
  ...
  public AutoRoutine safeAnimalStyle(boolean isLeft) {
    ...
    AutoTrajectory trench_and_bump_1 =
        isLeft
            ? routine.trajectory("trench_and_bump_1")
            : routine.trajectory("trench_and_bump_1").mirrorY();
    AutoTrajectory trench_and_bump_2_safe =
        isLeft
            ? routine.trajectory("trench_and_bump_2_safe")
  ...
  public AutoRoutine safeNeapolitanMilkshake(boolean isLeft) {
    ...
    AutoTrajectory bump_only_1_safe =
        isLeft
            ? routine.trajectory("bump_only_1_safe")
    ...
    bump_only_1_safe
        .atTime("deploy_intake")
        .onTrue(superstructureCommands.setWantedSuperStateCommand(WantedSuperState.IDLE_AUTO));
  ...
  public AutoRoutine greedyNeapolitanMilkshake(boolean isLeft) {
    ...
    AutoTrajectory bump_only_1_greedy =
        isLeft
            ? routine.trajectory("bump_only_1_greedy")
  ...
  public Command disregardRequirements(Command cmd) {
    return new FunctionalCommand(
        cmd::initialize, cmd::execute, cmd::end, cmd::isFinished
