...
public class IntakeRollersIOTalonFX extends IntakeRollersIO {
    ...
    public IntakeRollersIOTalonFX() {
        ...
        intakeRollersLeaderMotor = new TalonFX(IntakeRollersConstants.intakeRollersLeaderMotorID, intakeRollersLeaderCanBus);

        intakeRollersFollowerCanBus = new CANBus(IntakeRollersConstants.intakeRollersFollowerCanBus);
        intakeRollersFollowerMotor = new TalonFX(IntakeRollersConstants.intkaeRollersFollowerMotorID, intakeRollersFollowerCanBus);

        intakeRollersLeaderConfig = new TalonFXConfiguration()
                .withCurrentLimits(
        ...
        intakeRollersFollowerConfig = new TalonFXConfiguration()
                .withCurrentLimits(
                        new CurrentLimitsConfigs()
                                .withSupplyCurrentLimit(IntakeRollersConstants.supplyCurrentLimit)
                                .withSupplyCurrentLimitEnable(true)
                ...
                // .withOpenLoopRamps(new OpenLoopRampsConfigs().withVoltageOpenLoopRampPeriod(1.0))
                ;
        PhoenixUtil.tryUntilOk(10, () -> intakeRollersLeaderMotor.getConfigurator().apply(intakeRollersLeaderConfig, 1));
        PhoenixUtil.tryUntilOk(10, () -> intakeRollersFollowerMotor.getConfigurator().apply(intakeRollersFollowerConfig, 1));
        ...
        BaseStatusSignal.setUpdateFrequencyForAll(50,
                // intake rollers 1
                intakeRollersLeaderVelocity, intakeRollersLeaderAppliedVolts,
                intakeRollersLeaderStatorCurrent, intakeRollersLeaderSupplyCurrent, intakeRollersLeaderTemperature,
                // intake rollers 2
                intakeRollersFollowerVelocity, intakeRollersFollowerAppliedVolts, intakeRollersFollowerStatorCurrent,
                intakeRollersFollowerSupplyCurrent, intakeRollersFollowerTemperature);
    ...
    public void updateInputs() {
        BaseStatusSignal.refreshAll(
                // intake rollers 1
                intakeRollersLeaderVelocity, intakeRollersLeaderStatorCurrent, intakeRollersLeaderSupplyCurrent,
                intakeRollersLeaderAppliedVolts, intakeRollersLeaderTemperature
                // intake rollers 2
                , intakeRollersFollowerVelocity, intakeRollersFollowerStatorCurrent, intakeRollersFollowerSupplyCurrent,
                intakeRollersFollowerAppliedVolts, intakeRollersFollowerTemperature);
        ...
        super.intakeRollersFollowerStatorCurrent = intakeRollersFollowerStatorCurrent.getValueAsDouble();
    ...
    public void setVoltage(double voltage) {
        ...
        intakeRollersFollowerMotor.setControl(v_follower_request.withOutput(voltage).withEnableFOC(true));
    }
}
