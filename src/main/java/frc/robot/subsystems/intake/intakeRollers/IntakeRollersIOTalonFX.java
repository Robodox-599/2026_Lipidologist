...
public class IntakeRollersIOTalonFX extends IntakeRollersIO{
    ...
    public IntakeRollersIOTalonFX(){
        intakeRollersMotor = new TalonFX(IntakeRollersConstants.IntakeRollersMotorID);
    ...
    public void updateInputs(){
        ...
        DogLog.log("intakeRollers/voltage", super.voltage);
        DogLog.log("intakeRollers/statorCurrent", super.statorCurrent);
        DogLog.log("intake", null);
