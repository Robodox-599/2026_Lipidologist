...
public class IntakeRollersIOTalonFX extends IntakeRollersIO {
  ...
  public IntakeRollersIOTalonFX() {
    ...
    intakeRollersMotorOne =
        new TalonFX(IntakeRollersConstants.intakeRollersMotorOneID, intakeRollersCanBusOne);

    intakeRollersCanBusTwo = new CANBus(IntakeRollersConstants.intakeRollersCanBusTwo);
    intakeRollersMotorTwo =
        new TalonFX(IntakeRollersConstants.intkaeRollersMotorTwoID, intakeRollersCanBusTwo);

    intakeRollersMotorConfigOne =
    ...
    PhoenixUtil.tryUntilOk(
        10, () -> intakeRollersMotorOne.getConfigurator().apply(intakeRollersMotorConfigOne, 1));
    PhoenixUtil.tryUntilOk(
        10, () -> intakeRollersMotorTwo.getConfigurator().apply(intakeRollersMotorConfigTwo, 1));
    ...
    BaseStatusSignal.setUpdateFrequencyForAll(
        50,
        // intake rollers 1
        intakeRollersOneVelocity,
        intakeRollersOneAppliedVolts,
        intakeRollersOneStatorCurrent,
        intakeRollersOneSupplyCurrent,
        intakeRollersOneTemperature,
        // intake rollers 2
        intakeRollersTwoVelocity,
        intakeRollersTwoAppliedVolts,
        intakeRollersTwoStatorCurrent,
        intakeRollersTwoSupplyCurrent,
        intakeRollersTwoTemperature);
