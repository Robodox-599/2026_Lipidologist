...
public class HoodConstants {
  ...
  public static final double hoodRealkS = 0.31;
  public static final double hoodRealkV = hoodGearRatio * Constants.kMotors.kKrakenX60Foc.kV;
  public static final double hoodRealkG = 0.18;
