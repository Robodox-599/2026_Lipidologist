...
public class VisionConstants {
  ...
  public static final LerpTable ANGULAR_VELOCITY_STD_DEV_COEFFICIENT =
    ...
    // CAMERA 1 POSE (YAW)
    public static final double frontLeftCameraPoseYaw = Units.degreesToRadians(90+102); // 102.0 - 90.0 (left/right rotation)
    ...
    // CAMERA 2 POSE (ROLL)
    public static final double sideLeftCameraPoseRoll = Units.degreesToRadians(90-100.1894); // 5.9670
...
//     // CAMERA 3 POSE (YAW)
    ...
    // CAMERA 4 POSE (ROLL)
    public static final double sideRightCameraPoseRoll = Units.degreesToRadians(100.1894-90); // -4.4670
