...
public class VisionConstants {
  ...
  public static final double maxAngleError = Units.degreesToRadians(20);
  ...
  public static final LerpTable LINEAR_VELOCITY_STD_DEV_COEFFICIENT =
      new LerpTable(
          ...
          new LerpTable.LerpTableEntry(TunerConstants.MaxSpeed, 10));
  ...
  public record CameraConstants(
      String name, Transform3d robotToCamera, double stdDevFactor, boolean shouldRejectSingleTag) {}
  ...
  // CAMERA 1 POSE (X)
  public static final double frontLeftCameraPoseX =
      Units.inchesToMeters(-11.439); // -11.439 (Y value in CAD)

  // CAMERA 1 POSE (Y)
  public static final double frontLeftCameraPoseY =
      Units.inchesToMeters(8.487); // 8.487 (X value in CAD)

  // CAMERA 1 POSE (Z)
  public static final double frontLeftCameraPoseZ =
      Units.inchesToMeters(18.451); // 18.451 (Z value in CAD)

  // CAMERA 1 POSE (ROLL)
  public static final double frontLeftCameraPoseRoll = Units.degreesToRadians(-5.9670); // 5.9670

  // CAMERA 1 POSE (PITCH)
  public static final double frontLeftCameraPosePitch =
      Units.degreesToRadians(60.7203 - 90); // 90 - 60.7203 (up/down rotation)

  // CAMERA 1 POSE (YAW)
  public static final double frontLeftCameraPoseYaw =
      Units.degreesToRadians(90 + 102); // 102.0 - 90.0 (left/right rotation)

  // SIDE LEFT CAMERA
  public static final String sideLeftCameraName = "SL_Camera";

  // CAMERA 2 POSE (X)
  public static final double sideLeftCameraPoseX =
      Units.inchesToMeters(-9.604); // -11.439 (Y value in CAD)

  // CAMERA 2 POSE (Y)
  public static final double sideLeftCameraPoseY =
      Units.inchesToMeters(12.141); // -8.487 (X value in CAD)

  // CAMERA 2 POSE (Z)
  public static final double sideLeftCameraPoseZ =
      Units.inchesToMeters(16.913); // 18.451 (Z value in CAD)

  // CAMERA 2 POSE (ROLL)
  public static final double sideLeftCameraPoseRoll =
      Units.degreesToRadians(90 - 100.1894); // 5.9670

  // CAMERA 2 POSE (PITCH)
  public static final double sideLeftCameraPosePitch =
      Units.degreesToRadians(90 - 110.5000); // 109.3582-180 (up/down rotation)

  // CAMERA 2 POSE (YAW)
  public static final double sideLeftCameraPoseYaw =
      Units.degreesToRadians(180 - 61.7613); // 102.0 - 90.0 (left/right rotation)

  // FRONT RIGHT CAMERA
  public static final String frontRightCameraName = "FR_Camera";

  //     // CAMERA 3 POSE (X)
  public static final double frontRightCameraPoseX =
      Units.inchesToMeters(-11.354); // -11.354 (Y value in CAD)
  ...
  public static final double frontRightCameraPoseZ =
      Units.inchesToMeters(18.369); // 18.369 (Z value in CAD)

  //     // CAMERA 3 POSE (ROLL)
  public static final double frontRightCameraPoseRoll = Units.degreesToRadians(4.4670); // -4.4670

  //     // CAMERA 3 POSE (PITCH)
  public static final double frontRightCameraPosePitch =
      Units.degreesToRadians(68.5050 - 90); // 90 - 68.5050 (up/down rotation)

  //     // CAMERA 3 POSE (YAW)
  public static final double frontRightCameraPoseYaw =
      Units.degreesToRadians(180 - 12); // 90.0 - 102.0 (left/right rotation)

  // SIDE RIGHT CAMERA
  public static final String sideRightCameraName = "SR_Camera";

  // CAMERA 4 POSE (X)
  public static final double sideRightCameraPoseX =
      Units.inchesToMeters(-9.604); // -11.354 (Y value in CAD)

  // CAMERA 4 POSE (Y)
  public static final double sideRightCameraPoseY =
      Units.inchesToMeters(-12.141); // -8.487 (X value in CAD)

  // CAMERA 4 POSE (Z)
  public static final double sideRightCameraPoseZ =
      Units.inchesToMeters(16.913); // 18.369 (Z value in CAD)

  // CAMERA 4 POSE (ROLL)
  public static final double sideRightCameraPoseRoll =
      Units.degreesToRadians(100.1894 - 90); // -4.4670

  // CAMERA 4 POSE (PITCH)
  public static final double sideRightCameraPosePitch =
      Units.degreesToRadians(90 - 110.5000); // 90 - 68.5050 (up/down rotation)

  // CAMERA 4 POSE (YAW)
  public static final double sideRightCameraPoseYaw =
      Units.degreesToRadians(180 + 61.7613); // 90.0 - 102.0 (left/right rotation)
  ...
  public static final CameraConstants frontLeftCameraConstants =
      new CameraConstants(
          ...
          1,
          false);
  public static final CameraConstants sideLeftCameraConstants =
      new CameraConstants(
          sideLeftCameraName,
          new Transform3d(
              new Translation3d(sideLeftCameraPoseX, sideLeftCameraPoseY, sideLeftCameraPoseZ),
              new Rotation3d(
  ...
  public static final CameraConstants sideRightCameraConstants =
      new CameraConstants(
          sideRightCameraName,
          new Transform3d(
              new Translation3d(sideRightCameraPoseX, sideRightCameraPoseY, sideRightCameraPoseZ),
              new Rotation3d(
