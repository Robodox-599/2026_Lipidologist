...
public class TunerConstants {
  public static final double bumperRadius = Units.inchesToMeters(35.25 / 2);
  ...
  private static final Slot0Configs driveGains =
      new Slot0Configs().withKP(0.35).withKI(0).withKD(0).withKS(0.15).withKV(0.124);
  ...
  public static final CANBus kCANBus = new CANBus("BurgerCANivore", "./logs/example.hoot");
  ...
  private static final Angle kFrontRightEncoderOffset = Rotations.of(0.044677734375);
